  ...
  <section className='hero__section pt-[60px] 2xl:h-[800px]' >
    <div className='container'>
      ...
      <div>
        ...
        <p className='text__para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet hic adipisci eligendi dolorem laudantium. Quos unde placeat animi facilis deleniti dolorem eos quas, veniam ab facere id, ullam optio labore.</p>
  ...
  {/*-----hero section end ---- */}
    <section>
      <div className='container'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-
        [55px] '>
          ...
          <div className='xl:w-[670px]'>
            <h2 className='heading'>
              ...
              <ul className=''>
                ...
                <li className="text__para">
                  3. View our physicians who are accepting new patints, use the 
            ...
            <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:pb-[26px] rounded-[10px]'>
              <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]'>
                  ...
                  <h4 className='text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor'>Zahin Faizal</h4>
                </div>
            </div>
          </div>
        </div>
